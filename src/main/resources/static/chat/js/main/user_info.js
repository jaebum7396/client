...
function saveProfileImage(userProfileImage){
...
function makeAboutMeHub(){
    ...
    prompt += '너는 세개의 따옴표 안에 있는 해시태그들에 해당하는 사람이야. 해시태그들에 해당하는 사람이라는 어색한 설명 없이 200글자 이내의 짧은 자기소개 작성해줘. 허용된 답변의 길이를 넘으면 안돼 ';
